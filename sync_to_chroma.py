...
def main():
    ...
    for site_name in COMPLETED_SITES:
        ...
        # Try to find the main report file - could be either format
        main_report = None
        for possible_file in site_dir.glob("*.md"):
            if possible_file.name != "user-data.md" and "National" in possible_file.name:
                main_report = possible_file
                break
